...
class Net(nn.Module):
    ...
    #The protocol I follow while writing the Net module is:
    #Define all the layers in the __init__ module (including dropout and pooling)
    #Define the matrix operations in the "forward" function
    def __init__(self):
